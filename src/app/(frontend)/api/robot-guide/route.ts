...
export async function POST(req: Request) {
  try {
    ...
    // Sanitize user-supplied context before injecting into AI prompt (prevent prompt injection)
    // Truncate to 100 chars and strip non-printable/control characters
...
The user just scrolled to a section with the heading: "${safeContext}".
