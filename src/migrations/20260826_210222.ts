...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "homepage_settings_skills" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar NOT NULL,
  ...
  CREATE TABLE "homepage_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"hero_badge_text" varchar DEFAULT 'Open to opportunities',
  	"hero_title" varchar DEFAULT 'Hi, I''m a Full-Stack Developer' NOT NULL,
  	"hero_subtitle" varchar DEFAULT 'I build beautiful, fast, and scalable web applications.',
  	"hero_photo_id" integer,
  	"hero_primary_button_text" varchar DEFAULT 'View My Work',
  	"hero_secondary_button_text" varchar DEFAULT 'Get In Touch',
  	"skills_section_title" varchar DEFAULT 'My Skills',
  	"projects_section_title" varchar DEFAULT 'Featured Projects',
  	"projects_section_subtitle" varchar DEFAULT 'A selection of my best work.',
  	"blog_section_title" varchar DEFAULT 'Latest Thoughts',
  	"blog_section_subtitle" varchar DEFAULT 'Insights and articles on development, design, and tech.',
  	"contact_title" varchar DEFAULT 'Let''s Work Together',
  	"contact_subtitle" varchar DEFAULT 'Have a project in mind? I''d love to hear about it.',
  	"contact_email" varchar NOT NULL,
  	"contact_button_text" varchar DEFAULT 'Say Hello 👋',
  	"github_url" varchar,
  ...
  ALTER TABLE "homepage_settings_skills" ADD CONSTRAINT "homepage_settings_skills_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."homepage_settings"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "homepage_settings" ADD CONSTRAINT "homepage_settings_hero_photo_id_media_id_fk" FOREIGN KEY ("hero_photo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "homepage_settings_skills_order_idx" ON "homepage_settings_skills" USING btree ("_order");
  CREATE INDEX "homepage_settings_skills_parent_id_idx" ON "homepage_settings_skills" USING btree ("_parent_id");
  CREATE INDEX "homepage_settings_hero_photo_idx" ON "homepage_settings" USING btree ("hero_photo_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "homepage_settings_skills" CASCADE;
