...
import { PenTool, Eye, EyeOff, Edit, ArrowRight } from 'lucide-react'
    ...
    <div style={{ padding: '40px', maxWidth: '1200px', margin: '0 auto', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '32px' }}>
        ...
        <div style={{ display: 'flex', gap: '16px' }}>
          <StatCard title="Total" value={total} icon={<PenTool size={20} color="#4f46e5" />} bg="#e0e7ff" />
      ...
      <div style={{ 
        ...
        {data.docs.length === 0 ? (
          <div style={{ padding: '60px', textAlign: 'center', color: '#64748b' }}>
            <PenTool size={48} style={{ margin: '0 auto 16px', opacity: 0.2 }} />
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
              <thead>
                <tr style={{ background: '#f8fafc', borderBottom: '2px solid #e2e8f0' }}>
                  <th style={thStyle}>Blog Title & Slug</th>
              ...
              <tbody>
                {data.docs.map((doc, i) => {
                  ...
                  return (
                    <tr key={doc.id} className="blog-row" style={{ 
                      ...
                      <td style={{ ...tdStyle, fontWeight: 700, color: '#0f172a' }}>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                          <span style={{ fontSize: '1.1rem' }}>{doc.title}</span>
                      ...
                      <td style={tdStyle}>
                        <VisibilityClientActions id={doc.id} currentVisibility={doc.visibility || 'public'} collectionSlug="blogs" />
                      </td>
                      ...
                      <td style={tdStyle}>
                        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                          ...
                          <DeleteClientAction id={doc.id} collectionSlug="blogs" />
                        </div>
                      </td>
                    </tr>
                  )
      ...
      <PaginationUI page={data.page || 1} totalPages={data.totalPages || 1} collectionSlug="blogs" />
    </div>
  )
}
