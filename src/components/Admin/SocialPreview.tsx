  ...
  return (
    <div style={{ marginTop: '2rem', padding: '1.5rem', border: '1px solid #eaeaea', borderRadius: '8px', background: '#f9f9f9', fontFamily: 'sans-serif' }}>
      ...
      <p style={{ fontSize: '14px', color: '#666', marginBottom: '1.5rem', lineHeight: 1.5 }}>
        This shows how your post will look when shared on platforms like X (Twitter), LinkedIn, or Facebook. <br/>
        <strong>✨ AI Magic:</strong> Click the "Auto-generate" buttons above, or simply click <b>Save</b> to automatically generate an optimized title and description!
      </p>
