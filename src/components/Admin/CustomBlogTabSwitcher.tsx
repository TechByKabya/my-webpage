...
export const CustomBlogTabSwitcher: React.FC = () => {
  ...
  return (
    <div style={{ marginBottom: '2rem', marginTop: '-1rem' }}>
      <div style={{ 
        ...
        <button
          ...
          style={{
            ...
            background: tab === 'blog' ? 'linear-gradient(135deg, #3b82f6, #4f46e5)' : 'var(--theme-elevation-50)',
            color: tab === 'blog' ? '#fff' : 'var(--theme-elevation-500)',
            boxShadow: tab === 'blog' ? '0 4px 14px 0 rgba(79, 70, 229, 0.35)' : '0 1px 3px rgba(0,0,0,0.05)',
            transform: tab === 'blog' ? 'translateY(-1px)' : 'none'
          }}
        >
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        /* Toggling based on tabs using classes instead of IDs */
        ${tab === 'blog' ? `
          /* Hide SEO elements when in Blog tab */
        ...
        ` : `
          /* Hide Blog elements when in SEO tab */
          .blog-field,
        ...
        /* Globally hide the SEO plugin's Auto-generate buttons and Link Preview */
