    ...
    <div style={{ padding: '40px', maxWidth: '1200px', margin: '0 auto', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '32px' }}>
        <div>
          ...
          <p style={{ margin: '0 0 16px 0', color: '#64748b', fontSize: '1rem' }}>Manage your portfolio and showcase projects.</p>
          <Link href="/kabya-52005/collections/projects/create" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: '#0f172a', color: '#fff', textDecoration: 'none', padding: '8px 16px', borderRadius: '20px', fontSize: '0.85rem', fontWeight: 600, transition: 'opacity 0.2s' }}>
            + Create New Project
          </Link>
        </div>
